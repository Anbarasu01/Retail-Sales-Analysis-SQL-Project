...
-- SQL Retail Sales Analsis
create database Retail_sales;

use retail_sales;
-- Create Table
DROP TABLE IF EXISTS retail_sales.retail_sales_table;
CREATE TABLE retail_sales.retail_sales_table
	(
...
-- Cheack The NULL Values and Data Cleaning 
/*
Any null value is in the colume use the delete from table_name where condition
*/
...
-- How many Uniuque Customer you have?
